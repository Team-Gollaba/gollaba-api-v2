...
public class CacheKeys {
    ...
    private static final long TOP_POLLS_EXPIRATION_MIN = 24 * 60L;
    public static final String TRENDING_POLLS = "POLL::TRENDING";
    private static final long TRENDING_POLLS_EXPIRATION_MIN = 24 * 60L;
    public static final String POLL_DETAILS = "POLL::DETAILS";
    private static final long POLL_DETAILS_EXPIRATION_MIN = 60L;
    public static final String POLL_LIST_HOME = "POLL::LIST::HOME";
    private static final long POLL_LIST_HOME_EXPIRATION_MIN = 24 * 60L;
