...
public enum Status {
    ...
    INVALID_VOTE_ITEM_SIZE("투표 항목을 최소 1개이상 선택해주세요."),
    INVALID_SINGLE_VOTE_ITEM_SIZE("단일 선택 투표에는 1개의 항목만 선택할 수 있습니다."),
    EXCEED_MULTIPLE_VOTE_ITEM_SIZE("다중 선택 투표에서 선택할 수 있는 최대 항목 갯수를 초과하셨습니다."),
    INVALID_VOTE_ITEM("투표 항목이 올바르지 않습니다."),
    ;
