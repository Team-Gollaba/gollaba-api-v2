...
import org.tg.gollaba.notification.service.UpdateNotificationDeviceService;
import org.tg.gollaba.common.web.ApiResponse;

@RestController
@RequestMapping("/v2/app-notifications")
@RequiredArgsConstructor
public class UpdateNotificationDeviceController {
    private final UpdateNotificationDeviceService service;
