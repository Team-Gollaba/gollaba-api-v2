...
public class GetMyFavoritePollListControllerTest extends ControllerTestContext {
    private static final String TAG = Tags.POLL.tagName();
    private static final String DESCRIPTION = Tags.POLL.descriptionWith("특정 유저가 좋아요한 투표 전체 조회");

    @Autowired
    private GetMyFavoritePollListService getMyFavoritePollListService;

    @Test
    @WithMockUser(authorities = "USER")
    void success(){
        when(getMyFavoritePollListService.get(any(), any(Pageable.class)))
